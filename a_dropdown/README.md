## ADropDown
The package ADropDown como from Aletheia DropDown
the package is created to que app [**Aletheia Bible**](https://github.com/rodolfogoulart/aletheia-core-model)

## Features

Just a DropDown but with the option to build the Button and Menu by your self
You can use the dropDown to build multiple lists on a Row or do whatever you want
...
[Aletheia Bible](https://github.com/rodolfogoulart/aletheia-core-model)